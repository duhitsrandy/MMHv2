        ...
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-8 prose prose-lg prose-gray dark:prose-invert max-w-none">
            ...
            <ul>
                ...
                <li><strong>Routing and Location Services:</strong> Addresses and coordinates you provide are used to query third-party geocoding and routing APIs (like HERE, LocationIQ, OSRM, OpenRouteService) in real time to generate results. We use the results returned (midpoint coordinates, route geometry, travel time) to display maps and directions to you. We may cache geocoding, POI, and routing-related API responses in our Redis store for up to about 12–24 hours to improve performance when you or others search similar areas. Cached entries use rounded coordinates or hashed addresses, not your account ID.</li>
            ...
            <ul>
                ...
                <li><strong>Deletion (Right to Erasure):</strong> You have the right to request deletion of your personal data. You can delete your account from the app (Account menu or About → Delete Account) or by contacting us at <strong>support@meetmehalfway.co</strong>. Upon deletion (and provided we do not have a legal obligation to keep the data), we delete or anonymize your personal information from our active systems, including your profile, saved locations, and saved searches. As noted in "Data Retention", residual copies may remain in backups for a time, but will be purged in accordance with our backup retention schedule. Your account is closed as part of that process.</li>
